...
public class DateFifthTry {
    ...
    public void setDate(int month, int day, int year) { // Formal parameters
        if (dateOK(month, day, year)) {
            this.month = monthString(month);
            this.day = day; // * If the parameter's name was ,,day'', we would better write the code line ,,this.day = day'' to clarify
    ...
    public boolean equals(DateFifthTry otherDate) { // * Method overriding for customization as well
        return ((month.equalsIgnoreCase(otherDate.month))) &&
        (day == otherDate.day) && (year == otherDate.year);
    }

    public boolean precedes(DateFifthTry otherDate) { // * Hard
