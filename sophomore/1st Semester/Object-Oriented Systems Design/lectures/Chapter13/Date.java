...
public class Date {
    ...
    public Date(int year) {
        setDate(1, 1, year); // Invoke another method within constructor
    }
    ...
    public Date(Date aDate) {
        ...
        month = aDate.month; // How can we access to these object variables? Is it because I'm still within the same class?
        day = aDate.day;
        year = aDate.year;
    }
